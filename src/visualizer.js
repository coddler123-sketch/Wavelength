...
(function (exports) {
  // GLSL sources live in visualizer-shaders.js (script tag in browser, require in Node).
  const { vsSource, fsTunnel3D, fsValley3D, fsMatrix3D, fsMandala3D } =
    typeof module !== 'undefined' && module.exports
      ? require('./visualizer-shaders.js')
      : window.WavelengthShaders;
  const BAR_COUNT = 44;
